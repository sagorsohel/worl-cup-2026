...
const METADATA_TRANSLATIONS: Record<string, Record<string, string>> = {
  title_template: {
    ...
    zh: "{team} | 比赛直播、赛程与积分榜",
    ja: "{team} | ライブ配信、日程、結果、順位表",
    ko: "{team} | 라이브 매치, 일정 및 순위",
    vi: "{team} | Trực tiếp, Lịch thi đấu & Bảng xếp hạng",
  ...
  desc_template: {
    ...
    ja: "2026年FIFAワールドカップの「{team}」の全試合を無料オンラインライブ配信、結果、順位表、見どころからお届け。",
    ko: "2026 FIFA 월드컵 \"{team}\"의 모든 경기를 라이브 스코어, 순위, 하이라이트와 함께 실시간 스트리밍으로 감상하세요.",
    vi: "Xem trực tiếp trận đấu \"{team}\" tại FIFA World Cup 2026 bao gồm tỷ số, bảng xếp hạng và highlights.",
  ...
  not_found: {
    ...
    ja: "チームが見つかりません | FIFA WC26を画面で視聴",
    ko: "팀을 찾을 수 없습니다 | FIFA WC26 온 스크린",
    vi: "Không tìm thấy đội bóng | FIFA WC26 trên màn hình",
